...
namespace InfoBuraco2018Turma2Grupo2 {
	...
	private: System::Windows::Forms::Button^  bt_registroDeRealizaçãoDeOS;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bt_registroDeRealizaçãoDeOS = (gcnew System::Windows::Forms::Button());
			...
			this->ts_usuário->Size = System::Drawing::Size(463, 25);
			...
			// 
			// bt_registroDeRealizaçãoDeOS
			// 
			this->bt_registroDeRealizaçãoDeOS->BackColor = System::Drawing::SystemColors::Control;
			this->bt_registroDeRealizaçãoDeOS->Location = System::Drawing::Point(135, 104);
			this->bt_registroDeRealizaçãoDeOS->Name = L"bt_registroDeRealizaçãoDeOS";
			this->bt_registroDeRealizaçãoDeOS->Size = System::Drawing::Size(184, 31);
			this->bt_registroDeRealizaçãoDeOS->TabIndex = 8;
			this->bt_registroDeRealizaçãoDeOS->Text = L"Registro de Realização de OS";
			this->bt_registroDeRealizaçãoDeOS->UseVisualStyleBackColor = false;
			this->bt_registroDeRealizaçãoDeOS->Click += gcnew System::EventHandler(this, &MenuEncarregadoDaObra::bt_registroDeRealizaçãoDeOS_Click);
			// 
			// MenuEncarregadoDaObra
			// 
			...
			this->Controls->Add(this->bt_registroDeRealizaçãoDeOS);
...
#pragma endregion
	private: System::Void bt_registroDeRealizaçãoDeOS_Click(System::Object^  sender, System::EventArgs^  e) {
